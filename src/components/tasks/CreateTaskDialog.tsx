      ...
      <div className="bg-background border border-border rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="p-4 space-y-3 max-h-[60vh] overflow-auto">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              placeholder="可选描述"
              className="w-full px-2 py-1.5 text-sm border border-border rounded bg-background focus:outline-none focus:ring-1 focus:ring-primary resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-muted-foreground mb-1 block">进度 ({progress}%)</label>
              <input
                type="range"
                min={0}
                max={100}
            ...
            <div>
              <label className="text-xs text-muted-foreground mb-1 block">预估工时(h)</label>
              <input
                type="number"
        ...
        <div className="flex gap-2 px-4 py-3 border-t border-border">
          ...
          <button
            ...
            className="flex-1 py-1.5 text-xs bg-primary text-primary-foreground rounded hover:opacity-90 disabled:opacity-50"
          >
